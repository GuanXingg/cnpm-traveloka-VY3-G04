...
// lịch sử đặt vé
router.post("/history",middlewareController.verifyToken, usersController.history);
// cập nhật trạng thái đặt vé
router.post("/updateStatus",middlewareController.verifyToken ,usersController.updateStatus);
// khách đặt hủy vé
router.post("cancelBooking",middlewareController.verifyToken,usersController.cancelBooking)
// trang chủ
